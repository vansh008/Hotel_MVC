...
namespace Hotel_MVC.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(Hotel_MVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,First_Name,Last_Name,Gender,Email_Id,DOB")] Customer customer)
        {
